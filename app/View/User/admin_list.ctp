                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $this->Html->link('Edit',array('controller'=>'User','action'=>'edit',$val['User']['id']), array('class' => 'btn btn-warning'));
                                            ?>
                                            <?php echo $this->Html->link('Del',array('controller'=>'User','action'=>'delete',$val['User']['id']), array('class' => 'btn btn-danger'));
                                            ?>
                                        </td>
                                    </tr>
                                    <?php }?>
